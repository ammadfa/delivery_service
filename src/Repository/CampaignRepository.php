...
class CampaignRepository extends ServiceEntityRepository
{
    ...
    public function createByCampaignItemDetails($campaign_item_details) {
        $campaign = new Campaign();
        $campaign
            ->setName($campaign_item_details['name'])
            ->setType($campaign_item_details['type'])
            ->setAd($campaign_item_details['ad']);
